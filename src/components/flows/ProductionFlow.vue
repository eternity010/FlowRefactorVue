...
export default {
  ...
  methods: {
    ...
    async loadFlowData() {
      ...
      try {
        console.log('🔄 ProductionFlow组件开始从API加载生产流程图数据...');
        ...
        // 调用API服务
        const response = await subProcessDataApi.getMermaidFlowData('production');
        ...
        console.log('✅ ProductionFlow组件生产流程图数据加载成功:', {
        ...
        console.error('❌ ProductionFlow组件从API加载生产流程图数据失败:', error);
    ...
    async refreshFlowData() {
      console.log('🔄 ProductionFlow组件刷新数据');
    ...
    async checkApiConnection() {
      try {
        ...
        console.log('🔍 ProductionFlow API连接检查:', status);
        return status;
      } catch (error) {
        console.error('❌ ProductionFlow API连接检查失败:', error);
    ...
    getComponentStatus() {
      ...
      console.log('📊 ProductionFlow组件状态:', status);
      return status;
    }
  },
