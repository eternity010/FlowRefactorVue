<template>
  <div class="marketing-refactor-container">
    <div class="page-header">
      <el-page-header @back="goBack" content="营销环节重构" />
    </div>
    ...
    <div class="content">
      <el-card class="refactor-card">
        <div class="refactor-title">
          <h1>营销环节重构</h1>
          <p class="subtitle">Marketing Process Refactoring</p>
        </div>
...
export default {
  ...
  created() {
    ...
    this.nodeInfo = {
      ...
      nodeType: this.$route.query.nodeType || 'marketing'
    }
    
    console.log('📈 营销环节重构页面初始化:', this.nodeInfo);
  },
  methods: {
    goBack() {
      this.$router.go(-1);
